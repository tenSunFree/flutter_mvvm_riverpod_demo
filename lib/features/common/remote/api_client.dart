...
class ApiClient {
  static const String _baseUrl = 'https://api.pexels.com';
  ...
  void _setupInterceptors() {
    _dio.interceptors.addAll([
      _LoggingInterceptor(),
      _ErrorInterceptor(),
      _PexelsAuthInterceptor('1MvkJcZ4LTYJlQCHpTleM5MJtZsrazr03Ay7wrGXRl10dWx13jqpWQch'),
    ]);
  }
...
class _PexelsAuthInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions o, RequestInterceptorHandler h) {
    if (o.uri.host == 'api.pexels.com') {
      o.headers['Authorization'] = apiKey;
    }
    h.next(o);
  }
}
